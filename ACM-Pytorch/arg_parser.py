...
def arg_parser():
    ...
    parser.add_argument(
        "--dropout", type=float, default=0.8, help="Dropout rate (1 - keep probability)."
    )
    parser.add_argument("--hidden1", type=int, default=128, help="Number of hidden units.")
    ...
    parser.add_argument("--dataset_name", type=str, help="Dataset name.", default="texas")
    parser.add_argument("--k", type=int, help="Number of knn.", default=2)
    parser.add_argument(
        "--fixed_splits",
        type=float,
        default=0,
